...
public class Transaction extends AbstractTransaction {
  ...
  public NeedSignTransactionDTO getUnsignedTransaction(List<String> address) throws IOException {
    byte[] xdrByteArray = toEnvelopeXdr().toXdrByteArray();
    List<NeedSignSignatureDTO> unsignedSigs = address.stream()
            .map(e -> new NeedSignSignatureDTO(e, this.hashHex()))
